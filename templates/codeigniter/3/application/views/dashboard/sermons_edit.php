...
<div class="content-wrapper">
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                <h4 class="card-title">Edit a Sermon</h4>
                <p class="card-description">
                    Enter Details of a Sermon
                </p>
                <?php echo form_open_multipart('/sermons-update-single');?>
                <div class="forms-sample">
                    ...
                    <input type="text" class="form-control" name="preacher" placeholder="<?php echo $item['preacher']?> ">
                    </div>
                    <div>
                        <label >Date</label>
                        <div class="row">
                    ...
                    <div class="form-group">
                    <label >Content</label>
                    <textarea class="form-control" name="content" placeholder="<?php echo $item['content'] ?>" rows="5"></textarea>
                    </div>
                    <div class="form-group">
